package com.example.yusiqing.myapplication9;
...
public class MainActivity extends AppCompatActivity {
    ...
    private File fDownloadDirectory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fDownloadDirectory=Environment.getDownloadCacheDirectory();
  ...
  private void externalStoragePublicDirectory(View v){
       path=fExternalStoragePublicDirectory.getAbsolutePath();
      listFile(path);
  }
    private void externalStorageDirectory(View v){
        path=fExternalStorageDirectory.getAbsolutePath();
        listFile(path);
    }
    private void dataStorage(View v){
        path=fDataStorage.getAbsolutePath();
        listFile(path);
    }
    private void downloadCacheDirectory(View v){
        path=fDownloadDirectory.getAbsolutePath();
        listFile(path);
    }
